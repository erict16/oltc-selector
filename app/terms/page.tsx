...
export default function TermsPage() {
  return (
    <LegalPage title="Terms of Use" titleZh="使用条款">
      ...
      <LegalPair
        title="1. Private project / 私人项目"
        en={
          <p>
            By using this site you acknowledge that it is a{" "}
            <strong>private project</strong> of the author. It is provided for
            educational and convenience purposes only. It is{" "}
            <strong>
      ...
      <LegalPair
        title="2. No professional advice / 非专业意见"
        en={
          <p>
            Outputs are <strong>indicative type-designation suggestions</strong>{" "}
            based on simplified rules and publicly described catalogue axes.
            They are{" "}
            <strong>
              not engineering design, not type-test approval, and not a
              substitute for manufacturer engineering confirmation
            </strong>
            .
          </p>
        }
      ...
      <LegalPair
        title="3. No warranty / 不保证"
        en={
          <p>
            The site is provided <strong>“as is” and “as available”</strong>,
            without warranties of any kind, whether express or implied,
            including accuracy, completeness, fitness for a particular purpose,
            or non-infringement. Catalogue data may be incomplete, outdated, or
      ...
      <LegalPair
        title="4. Limitation of liability / 责任限制"
        en={
          <p>
            To the maximum extent permitted by law, the author shall not be
            liable for any direct, indirect, incidental, special, consequential,
            or punitive damages, or any loss of profit, data, business, or
            goodwill, arising from your use of or inability to use this site or
            its suggestions — including commercial, contractual, or technical
      ...
      <LegalPair
        title="5. Your responsibility / 您的责任"
        en={
          <p>
      ...
      <LegalPair
        title="6. Intellectual property / 知识产权"
        en={
          <p>
      ...
      <LegalPair
        title="7. No affiliation / 无隶属关系"
        en={
          <p>
            References to commercial type strings or product families do{" "}
            <strong>not</strong> imply partnership, agency, employment
            representation, or endorsement by those brands. Do not treat this
            site as corporate communication.
          </p>
        }
        zh={
          <p>
      ...
      <LegalPair
        title="8. Acceptable use / 可接受使用"
        en={
          <p>
            Do not misuse the site (including attempts to disrupt hosting,
            scrape in a way that harms the service, or present outputs as
            certified manufacturer documents). The author may modify or
      ...
      <LegalPair
        title="9. Governing note / 适用说明"
        en={
          <p>
            These terms are intended as a clear statement of the project’s
            private nature and limited purpose. Local mandatory consumer or
            other laws that cannot be excluded still apply where relevant.
          </p>
        }
        zh={
          <p>
