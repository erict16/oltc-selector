...
export default function PrivacyPage() {
  return (
    <LegalPage title="Privacy Policy" titleZh="隐私政策">
      ...
      <LegalPair
        title="1. What this site is / 本站性质"
        en={
          <p>
      ...
      <LegalPair
        title="2. Data we collect / 我们收集的数据"
        en={
          <>
            <p>
              <strong>We do not operate user accounts.</strong> Selection runs
              in your browser. Duty parameters you enter are processed locally
              and are not intentionally sent to a backend server of this
              project.
            </p>
            <p>
              Hosting (e.g. GitHub Pages) may automatically log standard
              technical data such as IP address, user agent, and request time.
              That data is controlled by the host’s policies, not by a separate
              analytics product of this project.
            </p>
          </>
        }
        zh={
          <>
            ...
            <p>
              托管方（如 GitHub Pages）可能自动记录
              IP、浏览器类型、访问时间等常规技术日志，适用托管方政策。
            </p>
          </>
        }
      />
      ...
      <LegalPair
        title="3. Cookies & local storage / Cookie 与本地存储"
        en={
          <p>
