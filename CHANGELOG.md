...
- Imax uses min-tap current for ±N as well as custom +/− (not only custom). ZH labels 额定电流 / 最大电流; EN keeps Imax.
- Um and Ust are derived captions (tap-side kV and ± steps). Step % is always on the form.
