...
- Rated/Um tag stays right (`ml-auto`), original 26px size. Label row is 28px with snug line-height so Latin descenders (g/p/y, Iᵤ) are not clipped; 66 kV select stays full width and level with 400 A.
