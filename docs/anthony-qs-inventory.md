...
- files: **171**
- unique QS: **82**
- replay: **49** (min-adequate 33, customer-specified 16)
- skip (latest R): **33**
- unread: **0**

## Skip reasons (latest R)

- 11 — incomplete duty (no recoverable Iᵤ from transformer or a single-row tech table).
- 4 — 3× singles; engine will not list 3× when a III cover exists.
- 4 — non-catalogue tap (10181W / 10192G / 10213G) — engine cannot emit.
- 4 — quoted Iᵤ below transformer duty; do not invent a cover.
...
- 1 — two ratings 40 MVA & 63 MVA / 110 kV on one QS.
- 1 — WSG OCTC — no engine series this cycle.
...
| QS260183 | R2 | 2026-02-10 | `WSL IV-800Y/170-6x5A` | GE (UTR) / OCTC PLTGU GRATI 153.75MVA | no | customer-specified |  |
...
| QS2603117 | R0 | 2026-03-06 | `WSLIV-600Y/72.5-7*6E` | MEE / OCTC | no | customer-specified |  |
...
| QS2603120 | R0 | 2026-03-13 | `WSL IV-600D/72.5 - 6x5A` | HLG-VEE / VEE 26_Inquiry OCTC WSL IV-600D/72.5-6x5 | no | min-adequate |  |
| QS2603121 | R0 | 2026-03-16 | `WSLIV-2000D/126-6X5 (B)` | Thu Duc Trafo | no | superseded | QS2603121-R1 |
| QS2603121 | R1 | 2026-03-17 | `WSLIV-2000D/126-6X5 (B)` | HLG / OCTC replacement for Thu Duc Transformer Company | no | min-adequate |  |
| QS2603122 | R0 | 2026-03-16 | `WSL II-800D/72.5 - 6x5A` | EEMC / EEMC PO26-631. EED2603_12 | no | min-adequate |  |
...
| QS2603127 | R1 | 2026-07-14 | `CM2III-500Y/72.5C-10191W` | HANAKA / OLTC Model: CM2III-500Y/72.5C-10191W | no | skip: two ratings 40 MVA & 63 MVA / 110 kV on one QS. |  |
...
| QS2603131 | R0 | 2026-03-30 | `WSLIV-600Y/72.5- 6x5A with hand wheel` | MEE | no | min-adequate |  |
| QS2603132 | R0 | 2026-04-06 | `WSLIV-600Y/72.5- 6x5A with hand wheel` | MEE | no | superseded | QS2603132-R0 |
| QS2603132 | R0 | 2026-04-07 | `WSLIV-600Y/72.5- 6x5A with hand wheel` | MEE | no | min-adequate |  |
...
| QS2604144 | R0 | 2026-04-30 | `WDL IV- 1000Y/126-06x05B with hand wheel` | EEMC / Transformer: 72 MVA, 303kV | no | min-adequate |  |
...
| QS2605153 | R0 | 2026-05-08 | `WSL II-800D/72.5 - 6x5A` | EEMC / EEMC PO26-661. EED2605_05 | no | min-adequate |  |
...
| QS2605154 | R1 | 2026-06-16 | `WSLII-600D/72.5-12x11D` | Sanaky / DETC 11 pos 66kV | no | customer-specified |  |
...
| QS2607182 | R0 | 2026-07-08 | `CM2I-1500/72.5B-10191W` | HLG (MBT) / for Australia market | yes | skip: quoted Iᵤ 1500 A below transformer duty I=1673.5 A (40 MVA / 13.8 kV HV); do not invent a cover. |  |
...
| QS2607193 | R0 | 2026-07-15 | `WSL II-800D/72.5 - 6x5A` | EEMC / EEMC PO26-025. EED2607_09 | no | min-adequate |  |
...
| QS2607198 | R0 | 2026-07-23 | `SHZVIII-1000Y/72.5C-10191W` | MEE / Nam Manh SPP | yes | skip: 145 MVA Nam Manh SPP; mail still has kV TBA. |  |
| QS2607199 | R0 | 2026-07-23 | `CV2III-600D/40.5-10091W` | HLG (MBT) / Transformer | yes | superseded | QS2607199-R0 |
| QS2607199 | R0 | 2026-07-24 | `CV2III-600D/40.5-10091W` | HLG (MBT) / Transformer | yes | min-adequate |  |
...
| QS2607203 | R0 | 2026-07-24 | `WSG II-800D/40.5-4x5A` | EEMC / EEMC PO26-028 - OCTC WSG II -800D/40.5-4x5A | no | skip: WSG OCTC — no engine series this cycle. |  |
...
| QS2607208 | R0 | 2026-07-29 | `CVIII-350D/40.5-10193W` | HLG | no | customer-specified |  |
| QS2607210 | R0 | 2026-07-31 | `CV2III-350Y/72.5-10193W` | EEMC / EEMC PO26-033. OLTC CV2-III-350Y-72.5-10193W | no | skip: EEMC PO26-033; mail confirms 10193W only — no transformer MVA/kV. |  |
| QS2608212 | R0 | 2026-08-04 | `WSLIV-600Y/72.5- 6x5A with manual drive` | MEE | no | superseded | QS2608212-R1 |
| QS2608212 | R1 | 2026-08-12 | `WSLIV-600Y/72.5- 6x5A with manual drive` | MEE | no | min-adequate |  |
...
| QS2608215 | R0 | 2026-08-17 | `CM2III-500Y/126C-10191W` | HLG (EVNNPC) / EVNNPC OLTC Retrofit | no | skip: EVNNPC ABB VCGNR retrofit; mail has no transformer MVA/kV. |  |
...
| QS2608219 | R0 | 2026-08-18 | `CV2III-600Y/72.5-10191W` | MEE / erence: Yen Bai & Tuyen Quang Biomass Power Plant | yes | skip: Yen Bai / Tuyen Quang biomass; mail asked for MVA/kV — still TBA. |  |
