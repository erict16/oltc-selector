...
- files: **171**
- unique QS: **82**
- replay: **17** (min-adequate 7, customer-specified 10)
- skip (latest R): **65**
- unread: **0**

## Skip reasons (latest R)

- 33 — incomplete duty (no recoverable Iᵤ/Ust from QS header).
...
- 2 — quoted CV2-350; duty I=349.9 A > 350×0.97 so CV2-350 is not eligible.
- 2 — CV2-500 is not a 2025 catalogue row.
- 1 — non-catalogue tap 10192G — engine cannot emit.
- 1 — quoted Iᵤ 500 A below transformer duty I=721.7 A; do not invent a cover.
- 1 — non-catalogue tap 10213G — engine cannot emit.
- 1 — quoted Iᵤ 350 A below transformer duty I=355.6 A; do not invent a cover.
- 1 — non-catalogue tap 10181W — engine cannot emit.
- 1 — quoted Iᵤ 600 A below transformer duty I=682.3 A; do not invent a cover.
- 1 — SHZV-1300 is not a 2025 catalogue current.

## Files

| qs | rev | date | model | customer/project | budgetary | tag / skip | superseded-by |
|---|---|---|---|---|---|---|---|
| QS260181 | R2 | 2026-02-13 | `CV2III-350D/126-10193G` | TIRATHAI TRANSFORMER / Unimicron (Thailand) Project | no | skip: incomplete duty (no recoverable Iᵤ/Ust from QS header). |  |
...
| QS260184 | R0 | 2026-02-09 | `CV2III-350Y/72.5-10193W` | AGT / Solar Project | no | skip: incomplete duty (no recoverable Iᵤ/Ust from QS header). |  |
| QS260186 | R0 | 2026-02-02 | `CV2III-350D/72.5-10193W` | AGT / Amarapura Project | no | skip: incomplete duty (no recoverable Iᵤ/Ust from QS header). |  |
...
| QS260192 | R2 | 2026-04-24 | `SHZVIII-1000Y/170C-10191W` | Bambang Djaja | no | skip: incomplete duty (no recoverable Iᵤ/Ust from QS header). |  |
...
| QS2602102 | R0 | 2026-02-25 | `HWVIII-400Y/40.5-10193W` | PT Bambang Djaja / 20260672 // OHOH.400.400 | no | skip: incomplete duty (no recoverable Iᵤ/Ust from QS header). |  |
...
| QS2602105 | R0 | 2026-05-06 | `CV2III-350D/40.5-10193W` | AGT / Transformer: 20MVA, 33kV, +6%-10%, 17 positions x 1.65% per step, Dyn11 | no | skip: quoted CV2-350; duty I=349.9 A > 350×0.97 so CV2-350 is not eligible. |  |
| QS2602107 | R0 | 2026-04-02 | `CV2III-350Y/72.5-10193W` | AGT / Transformer: 30MVA 66/11kV | no | skip: incomplete duty (no recoverable Iᵤ/Ust from QS header). |  |
...
| QS2602110 | R4 | 2026-04-20 | `CVI-700/72.5-10070` | SANAKY / Transformer: 18500kVA (60075) | no | skip: incomplete duty (no recoverable Iᵤ/Ust from QS header). |  |
...
| QS2604135 | R1 | 2026-04-20 | `CV2III-600Y/72.5-10193W` | GE (UNINDO) / OLTC RIAU GFPP 140 MVA | no | skip: incomplete duty (no recoverable Iᵤ/Ust from QS header). |  |
| QS2604137 | R0 | 2026-04-10 | `HWVIII-400D/40.5-10191W` | PT Bambang Djaja / Type HWV_ Ref. 20260243 | yes | skip: incomplete duty (no recoverable Iᵤ/Ust from QS header). |  |
| QS2604138 | R0 | 2026-04-29 | `CMIII-500Y/126B-14273W` | GE (UNINDO) / ANGOLA 75 MVA & 25 MVA | yes | superseded | QS2604138-R0 |
| QS2604138 | R0 | 2026-07-10 | `CMIII-500Y/126DE-14273W` | GE (UNINDO) / ANGOLA 75 MVA & 25 MVA | no | skip: incomplete duty (no recoverable Iᵤ/Ust from QS header). |  |
...
| QS2604141 | R0 | 2026-05-08 | `CV2III-600D/40.5-10193W` | PT Bambang Djaja | yes | skip: incomplete duty (no recoverable Iᵤ/Ust from QS header). |  |
...
| QS2604146 | R1 | 2026-06-05 | `CV2III-350D/72.5-12233W` | GE / OLTC CORMIDON 24 MVA | no | skip: incomplete duty (no recoverable Iᵤ/Ust from QS header). |  |
| QS2604148 | R0 | 2026-04-29 | `SHZVIII-1000Y/72.5C-10193W` | EEMC / VIN SPP project | no | superseded | QS2604148-R1 |
| QS2604148 | R1 | 2026-05-19 | `SHZVIII-1000Y/72.5C-10193W` | EEMC / VinEnergo SPP project | no | skip: incomplete duty (no recoverable Iᵤ/Ust from QS header). |  |
...
| QS2606169 | R0 | 2026-06-05 | `SHZVIII-1000Y/72.5C-10193W` | EEMC / Transformer: 250MVA-220kV, 80MVA-220kV | yes | skip: incomplete duty (no recoverable Iᵤ/Ust from QS header). |  |
| QS2606170 | R0 | 2026-06-05 | `SHZVIII-1000Y/72.5C-10193W` | MEE / Transformer: 250MVA-220kV, 80MVA-220kV | yes | skip: incomplete duty (no recoverable Iᵤ/Ust from QS header). |  |
...
| QS2606173 | R2 | 2026-07-09 | `HWVIII-400Y/72.5-10191W` | HLG / EVN substation UZF retrofit job | no | skip: incomplete duty (no recoverable Iᵤ/Ust from QS header). |  |
...
| QS2606180 | R1 | 2026-07-16 | `SHZVIII-1000Y/72.5B-18353W` | Bambang Djaja | no | skip: incomplete duty (no recoverable Iᵤ/Ust from QS header). |  |
...
| QS2607182 | R0 | 2026-07-08 | `CM2I-1500/72.5B-10191W` | HLG (MBT) / for Australia market | yes | skip: incomplete duty (no recoverable Iᵤ/Ust from QS header). |  |
...
| QS2607183 | R2 | 2026-07-31 | `CV2III-350D/40.5-10193W` | AGT / CV2III350D-40.5-10193W/ESE Tender/FY 2026-27 | no | skip: quoted CV2-350; duty I=349.9 A > 350×0.97 so CV2-350 is not eligible. |  |
| QS2607184 | R0 | 2026-07-06 | `CV2III-350D/40.5-10193W` | Hitachi Soe / OLTC for 3T ESE -2026-2027 Tender | no | superseded | QS2607184-R1 |
| QS2607184 | R0 | 2026-07-06 | `CV2III-350D/40.5-10193W` | Hitachi Soe / OLTC for 3T ESE -2026-2027 Tender | no | superseded | QS2607184-R1 |
| QS2607184 | R1 | 2026-07-06 | `CV2III-350D/40.5-10193W` | Hitachi Soe / OLTC for 3T ESE -2026-2027 Tender | no | skip: incomplete duty (no recoverable Iᵤ/Ust from QS header). |  |
...
| QS2608216 | R0 | 2026-08-17 | `SHZVIII-1300Y/126DE-18353W` | Bambang Djaja | no | skip: SHZV-1300 is not a 2025 catalogue current. |  |
